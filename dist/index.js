...
app.get("/mcp-api/sse", async (req, res) => {
    ...
    const searchId = req.headers['x-search-id'] || req.query.search_id || null;
    if (searchId) {
...
app.get("/deep-marketing-chat.html", (req, res) => {
    ...
    res.sendFile(path_1.default.join(__dirname, '../public/deep-marketing-chat.html'));
});
// Custom Chat routes
app.get("/chat", async (req, res) => {
    ...
    res.sendFile(path_1.default.join(__dirname, "../public/integrated-custom-chat.html"));
});
